      ...
      <form onSubmit={handleInitialSubmit} className="flex flex-col gap-3">
        ...
        <div className="text-sm text-gray-700 dark:text-gray-300 mb-2">
          <ul className="list-disc list-inside space-y-1">
            ...
            <li className={/\d/.test(password) ? 'text-green-600' : 'text-gray-500'}>At least one number</li>
            <li className={/[^A-Za-z0-9]/.test(password) ? 'text-green-600' : 'text-gray-500'}>At least one special character</li>
            <li className={password.length >= 6 ? 'text-green-600' : 'text-gray-500'}>Minimum 6 characters</li>
          </ul>
          {password.length > 0 && (
